...
export const CareerChoicesDashboard: React.FC<CareerChoicesDashboardProps> = ({
  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      {/* Header Banner - Lighter Blue & Yellow Theme */}
      <div className="bg-gradient-to-r from-sky-500 via-sky-600 to-sky-700 text-white rounded-2xl p-6 sm:p-8 border border-sky-400/40 shadow-sm relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-sm text-sky-100 max-w-3xl leading-relaxed font-normal">
              {t.careersHeaderDesc}
            </p>
          </div>

          {/* Quick Grade Reference Box */}
          <div className="bg-sky-900/80 backdrop-blur-xs border border-sky-400/40 rounded-xl p-4 shrink-0 min-w-[240px] shadow-sm">
            <p className="text-xs font-bold text-yellow-300 uppercase tracking-wider mb-1 font-mono">
              {lang === 'ms' ? 'Status Kelayakan Semasa Anda:' : 'Your Current Eligibility Status:'}
            </p>
            <div className="flex items-baseline gap-2">
              <span className="text-2xl font-black text-yellow-300">{totalCredits}</span>
              <span className="text-xs font-bold text-sky-100">{t.creditsSuffix}</span>
            </div>
            <div className="flex items-center gap-1.5 mt-2 text-[10px]">
              <span className={`px-2 py-0.5 rounded-full font-bold ${hasBmCredit ? 'bg-yellow-400 text-sky-950 shadow-xs' : 'bg-sky-800 text-sky-200'}`}>
                BM: {bmGrade || '-'}
              </span>
              <span className={`px-2 py-0.5 rounded-full font-bold ${hasEngCredit ? 'bg-yellow-400 text-sky-950 shadow-xs' : 'bg-sky-800 text-sky-200'}`}>
                ENG: {engGrade || '-'}
              </span>
              <span className={`px-2 py-0.5 rounded-full font-bold ${hasMathCredit ? 'bg-yellow-400 text-sky-950 shadow-xs' : 'bg-sky-800 text-sky-200'}`}>
                MATH: {mathGrade || '-'}
              </span>
            </div>
          </div>
        ...
        <div className="relative z-10 grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6 pt-6 border-t border-sky-400/40">
          <div className="flex items-center gap-2.5 p-2.5 bg-sky-900/50 backdrop-blur-xs rounded-xl border border-sky-400/30">
            <div className="w-8 h-8 rounded-lg bg-sky-700 text-yellow-300 flex items-center justify-center font-black text-xs shrink-0 shadow-xs">
              ABDB
            </div>
            <div className="min-w-0">
              <p className="text-xs font-bold text-white truncate">Angkatan Bersenjata</p>
              <p className="text-[10px] text-sky-200">RBAF Penanjong</p>
            </div>
          </div>

          <div className="flex items-center gap-2.5 p-2.5 bg-sky-900/50 backdrop-blur-xs rounded-xl border border-sky-400/30">
            <div className="w-8 h-8 rounded-lg bg-yellow-400 text-sky-950 flex items-center justify-center font-black text-xs shrink-0 shadow-xs">
              RB
            </div>
            <div className="min-w-0">
              <p className="text-xs font-bold text-white truncate">Royal Brunei Airlines</p>
              <p className="text-[10px] text-sky-200">Pilot, Cabin, MRO</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 p-2.5 bg-sky-900/50 backdrop-blur-xs rounded-xl border border-sky-400/30">
            ...
            <div className="min-w-0">
              <p className="text-xs font-bold text-white truncate">Polis Diraja Brunei</p>
              <p className="text-[10px] text-sky-200">RBPF Gadong</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2.5 p-2.5 bg-sky-900/50 backdrop-blur-xs rounded-xl border border-sky-400/30">
            ...
            <div className="min-w-0">
              <p className="text-xs font-bold text-white truncate">Brunei Gas Carriers</p>
              <p className="text-[10px] text-sky-200">LNG Maritime Cadet</p>
            </div>
          </div>
        </div>
      </div>
